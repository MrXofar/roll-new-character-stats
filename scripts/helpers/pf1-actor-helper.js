   ...
   // OVERRIDES
    async _Update(data){
        ...
        await this._actor.update({
            'system.abilities.str.value': data.str_final_score_unmod, 
            'system.abilities.dex.value': data.dex_final_score_unmod,
            'system.abilities.con.value': data.con_final_score_unmod,
            'system.abilities.int.value': data.int_final_score_unmod,
            'system.abilities.wis.value': data.wis_final_score_unmod,
            'system.abilities.cha.value': data.cha_final_score_unmod
        });
    }
}